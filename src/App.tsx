...
function App() {
  ...
  const [p1, setP2] = useState<number>(1);

  const onRolled = () => {
    if (p1) {
      let roll:number = Math.floor(Math.random() * 6) + 1;;
      let numbers:string[] = Array.from(gameState);
      ...
      if (temp + roll <= 99) {
        ...
        else if (temp === 47 || temp === 75 || temp === 97) {
          if (temp === 47) temp = 18;
          else if (temp === 75) temp = 42;
          else if (temp === 97) temp = 10;
        }
        else if (temp === 19 || temp === 40 || temp === 28) {
          if (temp === 19) temp = 37;
        ...
        setIndex(temp);
        document.getElementById("p")!.innerHTML = "You rolled: " + roll.toString();
        document.getElementById("turn")!.innerHTML = "Second player's turn";
        setP2(0);
      }
      else document.getElementById("p")!.innerHTML = "You rolled: " + roll.toString();
      document.getElementById("turn")!.innerHTML = "Second player's turn";
    }
      ...
      let roll:number = Math.floor(Math.random() * 6) + 1;;
      let numbers:string[] = Array.from(gameState);
      let temp2:number = index2;
      if (temp2 + roll <= 99) {
        temp2 = temp2 + roll;
        if (temp2 === 99) {
          alert("Player 2 won!")
        }
        if (temp2 === 47 || temp2 === 75 || temp2 === 97) {
          if (temp2 === 47) temp2 = 18;
          else if (temp2 === 75) temp2 = 42;
          else if (temp2 === 97) temp2 = 10;
        }
        else if (temp2 === 19 || temp2 === 40 || temp2 === 28) {
          if (temp2 === 19) temp2 = 37;
          else if (temp2 === 40) temp2 = 61;
          else temp2 = 75;
        }
        ...
        setIndex2(temp2);
        document.getElementById("p")!.innerHTML = "You rolled: " + roll.toString();
        document.getElementById("turn")!.innerHTML = "First player's turn";
        setP2(1);
      }
      else document.getElementById("p")!.innerHTML = "You rolled: " + roll.toString();
      document.getElementById("turn")!.innerHTML = "First player's turn";
  ...
  return (
    <div className="App">
      ...
      <h3 id="turn">First player's turn.</h3>

      <button style={{ zIndex: 100, margin: 20 }} onClick={() => onRolled()} >Press to roll</button>

      <p id="p" style={{ margin: -10 }}>0</p>
